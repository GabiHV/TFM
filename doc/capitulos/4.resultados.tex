...
a mayor velocidad se desplazará el \textit{frame}. Además, en la parte posterior del movimiento se puede observar otro vector que indica la magnitud de la velocidad,
de forma que mediante un código de colores puede determinarse su adecuación. Así pues, el verde indica que la velocidad lineal es menor a 0.5m/s, el amarillo que está entre
0,5m/s y 1m/s y rojo que está por encima del último umbral mencionado.
\begin{figure}[htbp]
    \centering
...
marcadores, de modo que el usuario puede rehacer la ruta a su conveniencia. 
\begin{figure}[htbp]
    \centering
