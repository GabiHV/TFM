...
\begin{itemize}
    ...
    Se escoge \textbf{Git} sobre alternativas como \textbf{Subversion} o \textbf{Mercurial} por su popularidad, su integración con plataformas de alojamiento de repositorios y su capacidad para trabajar de manera distribuida.
    ...
    Se escoge \textbf{Android Studio} sobre alternativas por su capacidad de emulación nativa de dispositivos Android sin necesidad de configuraciones adicionales.
    ...
    Se escoge \textbf{ROS} sobre alternativas como \textbf{PX4} o \textbf{ArduPilot} por su popularidad, su comunidad de usuarios y su capacidad para integrarse con diferentes lenguajes de programación y entornos de desarrollo.
    \item \textbf{C\#:} Lenguaje de programación orientado a objetos, que se empleó para el desarrollo de la aplicación en Unity \parencite{microsoftLenguajeProgramacin}.
    ...
    \item \textbf{Python:} Lenguaje de programación interpretado, que se empleó para el desarrollo de los nodos ROS \parencite{pythonGeneralPython}.
    ...
    \item \textbf{C++:} Lenguaje de programación compilado, que se empleó para el desarrollo del plugin de detección de AprilTags \parencite{microsoftBienvenidoNuevo}.
